...
class PeerConnectionClient private constructor(private val appContext: Context,
    ...
    private var remoteVideoEnabled: Boolean = false
    ...
    companion object {
        ...
        fun getInstance(context: Context,
                        ...
                        remoteVideoSink: VideoSink): PeerConnectionClient {
            if (instance == null)
